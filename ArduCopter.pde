...
{
    ai.update_one_hz_count();
    //test sonar comm
    //int16_t test_sonar_cm = sonar.distance_cm();
    //const int16_t test_sonar_thr= 50;
    //end
    ...
    //gcs_send_text_P(SEVERITY_HIGH, PSTR("TEST 1 HZ"));
    ...
    if (pre_arm_display_counter >= 30) {
        ...
        //test sonar comm
        //************************* * * * * * * * * * *************************//
        if (test_sonar_flag == 1)
        {gcs_send_text_P(SEVERITY_HIGH, PSTR("Object"));}

         switch (test_auto_mode_print)
         {
            case 1:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO TAKE OFF"));
                break;
            case 2:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO WP"));
                break;

            case 3:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO LAND"));
                break;

            case 4:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO RTL"));
                break;

            case 5:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO CIRCLE"));
                break;

            case 6:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO SPLINE"));
                break;

            case 7:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO GUIDE"));
                break;
            case 8:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO LOITER"));
                break;
            case 9:
                gcs_send_text_P(SEVERITY_HIGH, PSTR("AUTO AVOID"));
                break;
         }
