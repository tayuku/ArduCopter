...
{
    int16_t test_sonar_cm = 0;
    test_sonar_cm = sonar.distance_cm();
    int16_t test_sonar_thr_upper= 300;
    int16_t test_sonar_thr_lower= 50;
    
    float target_yaw_rate = 0;
    float target_climb_rate = 0;
    
    if (test_sonar_cm < test_sonar_thr_upper && test_sonar_cm > test_sonar_thr_lower )
        {        test_sonar_flag = 1;        }
    else
        { test_sonar_flag = 0; }
